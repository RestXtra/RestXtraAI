...
// badge: "soon" = 路由已存在但功能为铺底占位；"new" = 新落地能力。
export const sidebarItems: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "worklog-tools", title: "工具执行", url: "/worklog/tools", icon: Wrench, badge: "soon", disabled: true },
      { id: "worklog-llm", title: "LLM 录制", url: "/worklog/llm", icon: Brain, badge: "soon", disabled: true },
  ...
  },
  {
    ...
    label: "沙箱管理",
    items: [
      { id: "sandbox-hosts", title: "沙箱主机", url: "/sandbox/hosts", icon: Server, badge: "soon", disabled: true, perm: "sandbox.read" },
      { id: "sandbox-containers", title: "沙箱容器", url: "/sandbox/containers", icon: Boxes, badge: "soon", disabled: true, perm: "sandbox.read" },
      { id: "sandbox-egress", title: "出口范围", url: "/sandbox/egress", icon: ShieldCheck, badge: "soon", disabled: true, perm: "sandbox.read" },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    items: [
      ...
      { id: "approvals", title: "审批记录", url: "/system/intercept/approvals", icon: ClipboardList, perm: "sec.intercept.read" },
      { id: "audit", title: "审计日志", url: "/sec/audit", icon: ScrollText, badge: "new", perm: "sec.audit.read" },
    ],
  },
  {
    id: 7,
