  ...
  if (row.task_id) {
    return (
      <div className="space-y-0.5">
        <div className="font-medium font-mono text-xs">{row.task_id}</div>
      ...
      <div className="flex flex-1 flex-col gap-6 p-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-semibold text-xl">审批记录</h1>
            {pending.length > 0 && (
        ...
        {pending.length > 0 && (
          <section className="rounded-lg border border-amber-400/40 bg-amber-50/30 dark:bg-amber-950/10">
            <div className="flex items-center gap-2 border-amber-400/30 border-b px-4 py-3 font-medium text-amber-700 text-sm dark:text-amber-400">
        ...
        <section className="rounded-lg border">
          <div className="border-b px-4 py-3 font-medium text-muted-foreground text-sm">全部记录 ({rows.length})</div>
          {rows.length === 0 && !loading ? (
            <div className="py-16 text-center text-muted-foreground text-sm">暂无审批记录</div>
          ) : (
            <Table>
              <TableHeader>
                <TableRow>
