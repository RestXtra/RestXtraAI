...
"performing-hash-cracking-with-hashcat", "conducting-man-in-the-middle-attack-simulation"},
		Tools:  []string{"list_tasks", "spawn_task", "pause_task", "get_task_graph", "list_task_findings", "add_task_hint", "get_task_worker_trace", "list_task_worker_traces", "search_task_worker_traces"},
		MCP:    []string{"browser", "ScopeSentry"},
	},
}
